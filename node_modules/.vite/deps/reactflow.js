import {
  ...
  timer,
  zoom_default
} from "./chunk-BG6ODKDC.js";
import {
  require_react_dom
} from "./chunk-Y7RQE7KS.js";
import {
  require_react
} from "./chunk-ZMXMRVLT.js";
import {
  __commonJS,
  __toESM
...
var createRFStore = () => createWithEqualityFn((set2, get2) => ({
  ...initialState,
  setNodes: (nodes) => {
  ...
  panBy: (delta) => {
    const { transform: transform2, width, height, d3Zoom, d3Selection, translateExtent } = get2();
